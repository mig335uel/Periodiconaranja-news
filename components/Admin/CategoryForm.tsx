...
export default function CategoryForm() {
  ...
  useEffect(() => {
    const fetchCategories = async () => {
      ...
      setLoading(false);
      // Handle different data structure if API returns object with categories property
  ...
  const handleParentChange = (e: React.ChangeEvent<HTMLInputElement>) => {
    ...
    const foundId = foundCategory ? foundCategory.id : null;
    setParentId(foundId);

    setCategoryForm({ ...categoryForm, parent_id: foundId });
  };
