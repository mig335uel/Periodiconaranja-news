                    ...
                    <tbody className="bg-white divide-y divide-gray-200">
                        {Array.isArray(categorias) && categorias.map((categoria) => (
                            <tr key={categoria.id}>
                                ...
                                <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-900">{categoria.slug}</td>
                                <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-900">{categorias.find(c => c.id === categoria.parent_id)?.name || '-'}</td>
